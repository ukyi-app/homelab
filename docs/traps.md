...
| R2 pg 아카이브 reset --purge 가드(④) | gate | `tests/reset-pg-r2-archive.bats` |
| sealing key 백업 체인 DR fail-closed 게이트 | gate | `tests/sealed-secrets-restore.bats` |
| tf-reconcile 무인 apply 안전 불변식(destroy 가드 등) | iac | `infra/_test/tf_reconcile.bats` |
