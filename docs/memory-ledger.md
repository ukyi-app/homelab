...
limit over-commit을 허용하므로, limit 합(현재 8028)은 *동시-peak 상한*일 뿐 실사용이 아니다.
...
tailscale proxy는 무제한이었으나 같은 날 거버넌스 캡 신설해 예산에 편입.) 따라서 명목 잔여(9216−8028 = 1188)는
...
**합계:** req ≈ 4367 Mi · limit ≈ 8028 Mi (반드시 ≤ 9216 Mi 유지).
