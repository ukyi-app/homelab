...
| `platform/` | ArgoCD가 싱크하는 GitOps 컴포넌트 (argocd · traefik · cnpg · victoria-stack · sealed-secrets · edge 3종[adguard·cloudflared·tailscale] · cache · data-conn · network-policies · namespaces) |
