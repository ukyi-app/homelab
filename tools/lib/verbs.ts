...
import { EXT_RE, resourceNameError } from "./identity.ts";
...
export type Verb = DoctorVerb | StatusVerb | DbCreateVerb | CliOnlyVerb;
...
export const VERBS: readonly Verb[] = [DOCTOR, STATUS, DB_CREATE, DB_URL];
